  ...
  return (
    <section className="hero relative bg-cover bg-center py-20" style={{backgroundImage: "url('/images/hero-bg-construction.jpg')"}}>
      <div className="bg-black/40 p-8 rounded-lg max-w-4xl mx-auto text-center">
        ...
        {/* New Subtitle */}
        <h2 className="text-xl sm:text-2xl text-gray-300 mb-6 tracking-wide">
        ...
        <p className="text-lg sm:text-xl text-gray-200 mb-8 leading-relaxed">
          Hi, I’m <strong>Charles Thomes</strong>, a North Carolina licensed General Contractor and qualified GC examiner. 
          I spent over 11 years building new construction projects across the state—before focusing on consulting.
        </p>
